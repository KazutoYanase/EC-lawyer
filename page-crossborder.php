...
<div class="ecl-pg">
	...
	<div class="ecl-pg-box">
		...
		<div class="ecl-pg-lead">
			実店舗を構える小売業と異なり、通販・EC事業には国境はありません。商品力さえあれば、海外の顧客に対して商品を販売することで、ビジネスを大きく拡大することができます。ファースト＆タンデムスプリント法律事務所では、国際ビジネスを支援してきた豊富な経験に基づいて、越境ECにチャレンジするクライアント企業様を応援します。
		</div>
