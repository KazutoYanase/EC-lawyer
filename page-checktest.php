...
-->
	<div class="ecl-pg-header" style="background-image:url(<?php echo esc_url( get_template_directory_uri()) ; ?>/img/pg_bg_check.jpg)">
	...
	<div class="ecl-pg-box">
		...
		<div class="check_red_title">
		ECビジネスをされている企業の方へ<br>
		このような問題はありませんか？
		</div>
		
		<div class="check_box__wrap">
			<div class="check_blue_box_l">契約について</div>
			<div class="check_check_box">
				<ul>
					<li>ひな形をそのまま利用していませんか？</li>
					<li>大きな損害賠償責任を負っていませんか？</li>
					<li>知的財産権を取得できていますか？</li>
				</ul>
			</div>
		</div>
		
		<div class="check_box__wrap">
			<div class="check_blue_box_r">規約について</div>
			<div class="check_check_box">
				<ul>
					<li>個人情報について、利用者から法律上必要な許諾を得ていますか？</li>
					<li>意図せず海外輸出されてしまった場合のリスクをコントロールできていますか？</li>
					<li>キャンセルや返品に関するトラブルを回避できる規約になっていますか？</li>
				</ul>
			</div>
		</div>
		
		<div class="check_box__wrap">
			<div class="check_blue_box_l">広告について</div>
			<div class="check_check_box">
				<ul>
					<li>他社の広告の著作権を侵害していませんか？</li>
					<li>景品表示法や薬事法などを守った内容になっていますか？</li>
					<li>マーケティングが違法にならない対策をしていますか？</li>
				</ul>
			</div>
		</div>
		
		</div>
		<div class="check_service__title">
			<h2>当事務所の契約・規約・<br class="sp">広告チェックサービス</h2>
		</div>
	...
	<div class="ecl-pg-box">
		...
		if( $news_posts ) :
		?>
		<section class="check_interview_box">
			<div class="check_interview_inner">
				<ul class="check_interview_item">
