<?php
/**
 * Template Name: Seminars and Lectures */
?>
    <?php get_header(); ?>
	...
	<!-- news -->
	<section class="section-wrap news archive">
		<div class="section-inner">
			<h1 class="section-title">
				<span class="font-lato font-lato__bold-i">Seminars and Lectures</span>
				<span class="small">セミナー・講演</span>
			</h1>
				...
				$args =	array(
                        ...
                        'tax_query' => array(
                            array(
                                'taxonomy' => 'news_cat',
                                'field' => 'slug',
                                'terms' => 'news-seminars-and-lectures'
                            )
                        ),
						'post_status'      => 'publish',
						'caller_get_posts' => 1,
			...
			?>
				<li>
					<?php if($newsUrl) : ?>
						<a href="<?php echo $newsUrl ?>" target="_blank">
