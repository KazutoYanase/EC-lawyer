		...
		<section class="profile" id="profile">
			...
			<div class="profile_">
				<div class="profile__upper">
					<div class="section-inner">
						<div class="profile__upper_sp">
							<img src="<?php echo esc_url( get_template_directory_uri()) ; ?>/img/prof_ono.png" srcset="<?php echo esc_url( get_template_directory_uri()) ; ?>/img/prof_ono.png 1x,<?php echo esc_url( get_template_directory_uri()) ; ?>/img/prof_ono@2x.png 2x" alt="" width="343" height="379" class="profile__upper__img hide-sm">
							<img src="<?php echo esc_url( get_template_directory_uri()) ; ?>/img/ph_ono_sp.png" alt="" width="150" class="profile__upper__img_sp hide-pc">
							<div class="profile__upper__title">
								<p class="font-lato font-lato__i profile__upper__title01">Profile</p>
								<p class="profile__upper__title02">弁護士</p>
								<p class="profile__upper__title03">小野 智博</p>
							</div>
						</div>
						<div class="profile__upper__message">
							<p>
								弁護士法人ファースト＆タンデムスプリント法律事務所　代表弁護士<br>
								慶應義塾大学環境情報学部、青山学院大学法科大学院卒業。企業法務、国際取引、知的財産権、訴訟に関する豊富な実務経験を持つ。日本及び海外の企業を代理して商取引に関する法務サービスを提供している。<br>
								2008年に弁護士としてユアサハラ法律特許事務所に入所。2012年に米国カリフォルニア州に赴任し、 Yorozu Law Group (San Francisco) 及び Makman and Matz LLP (San Mateo) にて、米国に進出する日本企業へのリーガルサービスを専門として、経験を積む。<br>
				...
				<div class="profile__upper">
					<div class="section-inner">
						<div class="profile__upper_sp">
							<img src="<?php echo esc_url( get_template_directory_uri()) ; ?>/img/prof_fujii.png" srcset="<?php echo esc_url( get_template_directory_uri()) ; ?>/img/prof_fujii.png 1x,<?php echo esc_url( get_template_directory_uri()) ; ?>/img/prof_fujii@2x.png 2x" alt="" width="343" height="379" class="profile__upper__img hide-sm">
							<img src="<?php echo esc_url( get_template_directory_uri()) ; ?>/img/ph_fujii_sp.png" alt="" width="150" class="profile__upper__img_sp hide-pc">
							<div class="profile__upper__title">
								<p class="font-lato font-lato__i profile__upper__title01">Profile</p>
								<p class="profile__upper__title02">弁護士</p>
								<p class="profile__upper__title03">藤井 総</p>
							</div>
						</div>
						<div class="profile__upper__message">
							<p>
			...
			*/ ?>
			...
			<div class="bg_world">
				<div class="section-wrap staff">
					<div class="section-inner">
						<h2 class="section-title">
							<span class="font-lato font-lato__bold-i">Member</span>
							<span class="small">有資格者メンバー</span>
						</h2>
						<ul class="staff__list">
							...
							<li class="staff__item">
								<img src="<?php echo esc_url( get_template_directory_uri()) ; ?>/img/prof_hashimoto_emi.png" alt="" width="120" height="120">
								<dl>
									<dt>橋本 えみ</dt>
									<dd>行政書士有資格者</dd>
								</dl>
							...
							<li class="staff__item">
								<img src="<?php echo esc_url( get_template_directory_uri()) ; ?>/img/prof_deguchi.png" alt="" width="120" height="120">
								<dl>
									<dt>出口 千晶</dt>
									<dd>行政書士有資格者</dd>
								</dl>
							...
							<li class="staff__item">
								<img src="<?php echo esc_url( get_template_directory_uri()) ; ?>/img/prof_murakami.png" alt="" width="120" height="120">
								<dl>
									<dt>村上 建太</dt>
									<dd>行政書士有資格者</dd>
								</dl>
